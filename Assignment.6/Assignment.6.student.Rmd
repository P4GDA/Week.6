...
#### b.
(3 marks)
Use a while loop to identify the name of the most highly expressed gene in lymphocytes that is not expressed in any other tissue type (not expressed = expressed below 1). Assign the name of this gene to a variable named "top_genes_lymphocytes_only".
...
#### b.
(2 marks)
Use either type of loop or vectorized code to identify the gene with the highest expression in the kidney cortex ("Kidney.Cortex") that is not expressed below 1 in the kidney medulla ("Kidney.Medulla"). Assign the name of the gene to a variable called "top_gene_cortex_not_medulla".

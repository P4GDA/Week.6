...
In the Supplement 6.1 we looked at a real-life example that is similar to a for loop: a scientist is working in the lab with six samples, and for each sample the scientist needs to add 10 uL of lysis buffer and then place the sample on ice:

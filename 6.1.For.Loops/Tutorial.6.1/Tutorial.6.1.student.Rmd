...
Write a for loop that replaces each number in `num_vect` with the square root of the number. Hint: iterate through the vector index.
...
Both steps should be completed within your loop. Hint: you can iterate through the previously generated `diseases` vector and use the information in your new column `pathogenic`.

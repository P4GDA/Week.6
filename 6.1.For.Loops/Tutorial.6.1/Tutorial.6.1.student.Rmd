...
Both steps should be completed within your loop. Hint: you can iterate through the previously generated `diseases` vector and use the information in your new `pathogenic` column.

...
Write nested for loops to loop through *positional* row and column indices and divide element by the number of disease variants for the appropriate disease.
```{r}
# Write and execute your code here
...
Write code to create the same vector as above by vectorizing the code. Call the vector you create "gene_chromosomes_2".
```{r}
# Write and execute your code here

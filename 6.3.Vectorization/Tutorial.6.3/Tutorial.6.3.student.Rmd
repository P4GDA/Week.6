...
Write nested for loops to loop through *positional* row and column indices of the `variant_significance_by_disease` matrix and divide the element by the number of disease variants for the appropriate disease.
